---
name: techmemo
description: How to write a Compass Tech Memo
license: MIT
...
# Tech Memo Template - \<your title here\>
...
*Why* are we doing this? What *business problem* led you to create this proposal? *KPIs impacted and estimates*.  Include a short summary of what you are proposing we do about this problem.
...
See [Overview instructions](https://docs.google.com/document/d/1RrG5smhhITEP4mmkXbXTIdyOMhwz6uGctanFUh86674/edit#heading=h.zgfm8fx3ohvm) for more details.
...
What must be achieved to consider this problem solved? What constraints must you adhere to when creating your solution?

See [Goals instructions](https://docs.google.com/document/d/1RrG5smhhITEP4mmkXbXTIdyOMhwz6uGctanFUh86674/edit#heading=h.zct233eqisb1) for more details.
...
See [Proposed Solution instructions](https://docs.google.com/document/d/1RrG5smhhITEP4mmkXbXTIdyOMhwz6uGctanFUh86674/edit#heading=h.s57ffzzg10y4) for more details.
...
How *else* did you consider solving this problem?

See [Alternatives Considered instructions](https://docs.google.com/document/d/1RrG5smhhITEP4mmkXbXTIdyOMhwz6uGctanFUh86674/edit#heading=h.rkumfe70sg1n) for more details.
...
Does this introduce novel patterns to Compass with which we aren’t experienced? Operate outside of the golden path in any way? What are the consequences of being wrong about your decisions? Will the company lose money? Decreased agent trust through incidents? 

See [Risks instructions](https://docs.google.com/document/d/1RrG5smhhITEP4mmkXbXTIdyOMhwz6uGctanFUh86674/edit#heading=h.sl7mjr88dujt) for more details.
...
Note: not all the sections described below are part of the tech memo template, but they can be added if needed. If they were all added, then we should just be using the tech spec template.
